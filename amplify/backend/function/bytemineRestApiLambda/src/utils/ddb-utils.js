...
const ddbGetItem = async (tableName, key, verbose = false) => {
	const params = {
		TableName: tableName,
		Key: key,
	};
...
const ddbPutItem = async (tableName, item, verbose = false) => {
	const params = {
		TableName: tableName,
		Item: item,
	};
...
const ddbUpdateItem = async (tableName, key, updateExpression, expressionAttributeNames, expressionAttributeValues, verbose = false) => {
	const params = {
		TableName: tableName,
		Key: key,
...
const ddbDeleteItem = async (tableName, key, verbose = false) => {
	const params = {
		TableName: tableName,
		Key: key,
	};
