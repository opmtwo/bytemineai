...
//const perPageOptions = [10, 25, 50,100,250,500].map((value) => ({ id: value, name: value.toString() }));
...
const Pagination = ({
	...
	return (
		<div className="pagination is-flex is-align-items-center is-fullwidth is-justify-content-start">
			...
			<span
				className={classNames('icon is-clickable mx-3', { 'is-disabled': isPrevDisabled })}
				onClick={isPrevDisabled ? undefined : onPrev}
			>
				<IconArrowLeft />
			</span>
			<span
				className={classNames('icon is-clickable mx-3', { 'is-disabled': isNextDisabled })}
