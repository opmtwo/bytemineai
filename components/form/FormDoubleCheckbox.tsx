...
const FormDoubleCheckbox = ({
	...
	const cssClassNames = classNames('icon is-flex is-relative has-border has-radius is-clickable has-text-grey is-unselectable p-3 mr-3', className);
	...
	return (
		<>
			<label htmlFor={id} className="is-flex is-align-items-center is-clickable is-unselectable is-checkbox">
				...
				<span className={error ? 'has-text-danger' : 'has-text-grey'} style={{ whiteSpace: 'nowrap', fontSize: '85%' }}>
					{label}
				</span>
			</label>
