...
import CampaignContactList from "../components/CampaignContactList"
import FormCheckbox from '../../../form/FormCheckbox';

const CampaignContactItems = ({
    items = [],
    isBusy,
    isNewDisabled,
    onNew,
    ...
    return (
        <Card className="is-scroll-view">
            <Slot slot="header">
                <div className="is-flex is-align-items-center mr-a is-flex-grow-2">
                    <FormCheckbox
                        className='ml-3 mr-5'
                        isChecked={false}
                    />
                    ...
                    <span className="has-text-grey ml-5">291 results</span>
...
export default CampaignContactItems;
