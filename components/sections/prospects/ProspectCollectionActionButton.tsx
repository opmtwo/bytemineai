...
import { ActionList, Contact, List } from '../../../types';
import {
    notifyError,
    notifySuccess,
...
import CreatableMultiContacts, { createOption, MultiSelectOption } from './CreatableMultiContacts';
...
const ProspectCollectionActionButton = ({
  selectedAction = '',
  contacts = [],
  displayItems = [],
...
export default ProspectCollectionActionButton;
